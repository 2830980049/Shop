...
<script type="text/javascript">
	function save_page(){
		window.location.href="${pageContext.request.contextPath }/CategoryServlet.do?method=save_page";
	}
</script>
</head>
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tbody>
                            ...
                            <tr class="message-unread">
                                ...
                                <td>${c.cdesc}</td>
                                <td>
                                    <a href="${ pageContext.request.contextPath }/CategoryServlet.do?method=edit&cid=${c.cid}">编辑</a>
                                    <a href="${ pageContext.request.contextPath }/CategoryServlet.do?method=delete&cid=${ c.cid }">删除</a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>
